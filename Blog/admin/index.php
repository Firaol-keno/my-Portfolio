...
//fetch current user's posts from database
 ...
 //$query = "SELECT posts.id, posts.title, posts.category_id FROM posts JOIN users ON posts.author_id = 
 //users.id WHERE  posts.author_id=$current_user_id ORDER BY posts.id DESC";
